...
public:
    ...
    void setupUi(QDialog *DialogNPCEdit)
    {
        ...
        gridLayout->addWidget(isBossCheckbox, 8, 0, 1, 1);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 452, 596));
    ...
    void retranslateUi(QDialog *DialogNPCEdit)
    {
        ...
        comboBoxIA->clear();
        comboBoxIA->insertItems(0, QStringList()
         << QApplication::translate("DialogNPCEdit", "Stand Still", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("DialogNPCEdit", "Wait to Attack", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("DialogNPCEdit", "Follow Player", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("DialogNPCEdit", "Zig-Zag", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("DialogNPCEdit", "Side to Side", 0, QApplication::UnicodeUTF8)
        );
